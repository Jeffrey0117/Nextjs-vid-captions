...
export default function VideoPlaybackControls({
  ...
  return (
    <div className={`flex items-center justify-between px-2 py-1 border-t bg-zinc-900 ${className}`}>
      ...
      <div className="flex items-center gap-0.5">
        ...
        {showEditingTools && (
          <>
            ...
            <button
              ...
              title="分割保留左側 (Ctrl+Q)"
            >
              <ArrowLeftToLine className="w-3 h-3 text-white" />
            </button>
            ...
            <button
              ...
              title="分割保留右側 (Ctrl+W)"
            >
              <ArrowRightToLine className="w-3 h-3 text-white" />
            </button>
        ...
        {showBookmarks && (
          <>
            ...
            >
              <Bookmark
                className={`w-3 h-3 ${isBookmarked ? 'fill-blue-500 text-blue-500' : 'text-white'}`}
              />
            </button>
          </>
        )}
