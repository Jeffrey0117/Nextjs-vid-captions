        ...
        {showPreview && (
          <div className="border-t border-gray-700 p-3 bg-gray-800/50">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="w-20"
                  />
                  <span className="text-xs text-gray-400 w-6">{subtitleFontSize}px</span>
                </div>
            ...
            <p className="text-xs text-gray-400 mt-1">
              {videoUrl 
                ? "調整字體大小滑桿預覽效果，調整時間滑桿來選擇影片畫面，拖拽字幕到想要的位置，然後點擊「套用到所有字幕」" 
                : "調整字體大小滑桿預覽效果，拖拽字幕到想要的位置，然後點擊「套用到所有字幕」來批量調整位置和字體"
              }
            </p>
          </div>
        )}
